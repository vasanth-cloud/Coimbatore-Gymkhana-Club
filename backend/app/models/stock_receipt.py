...
class StockReceiptItem(BaseModel):
    ...
    total_bottles = Column(Integer, nullable=False, default=0)
    rate_per_case = Column(Numeric(10, 2), nullable=False, default=0.0)
    added_value_percent = Column(Numeric(6, 2), nullable=False, default=220.0)
    tcs_amount = Column(Numeric(10, 2), nullable=False, default=0.0)
    total_line_cost = Column(Numeric(10, 2), nullable=False, default=0.0)
    calculated_basic_cost = Column(Numeric(10, 2), nullable=False, default=0.0)
    mrp = Column(Numeric(10, 2), nullable=False, default=0.0)
    selling_price = Column(Numeric(10, 2), nullable=False, default=0.0)
